...
**Current Implementation:** Stamp identification and valuation app (StampSnap), but 100% generic at the code level.
...
- Check AsyncStorage persistence: look for `visionidentifier-storage` key
